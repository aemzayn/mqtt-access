...
description: How MQTT Access handles data — what's stored locally, what's sent over the network, and what isn't collected.
---
...
This policy may be updated over time. Updates are documented in the project
changelog.
