...
description: How to report a security vulnerability in MQTT Access, and what versions currently receive security fixes.
---
...
Preferred channels:
1. [GitHub Security Advisories (private)](https://github.com/aemzayn/mqtt-access/security/advisories/new)
